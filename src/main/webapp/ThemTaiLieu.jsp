            ...
            <div class="card-body">
                <form action="themTaiLieu" method="POST">
                    <div class="form-group">
                        ...
                        <label>Giá</label>
                        <input type="number" class="form-control ml-2" name="gia">
                        <label>Nhà xuất bản</label>
                        <input type="text" class="form-control ml-2" name="nxb">
                        <label>Số lượng</label>
                        <input type="number" class="form-control ml-2" name="soluong" value="0">
                        <label>Tác giả</label>
                        <input type="text" class="form-control ml-2" name="tacgia">
...
<c:if test="${not empty addTLFailer}">
    <script>
