...
<div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar">
        <div class="p-4 pt-5">
            <a href="BanDoc.jsp" class="img logo rounded-circle mb-5"
               style="background-image: url(../../../../Java/QuanLyThuVien/web/images/bandocpage/logo.jpg);"></a>
            <ul class="list-unstyled components mb-5">
                <li>
                    <a href="MuonTaiLieu.jsp">Tìm tài liệu</a>
                </li>
                <li>
                    <a href="TraTaiLieu.jsp">Đăng ký thẻ bạn đọc</a>
                </li>
                <li>
                    <a href="PhieuMuon.jsp" class="btn btn-success mt-4">Đăng xuất</a>
                </li>
            </ul>
    ...
    <div id="content" class="p-4 p-md-5">
        ...
        <h2 class="mb-4">Xin chào, ${bandoc.getNguoiDung().getTen()}</h2>
