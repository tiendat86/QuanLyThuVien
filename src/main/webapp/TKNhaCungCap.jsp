...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
        ...
        <form action="tkNhaCungCap" method="post" style="display: inline">
        ...
        <c:if test="${tknhacungcaps.size() > 0}">
            <table class="table table-striped table-inverse">
                ...
                <tbody>
                <c:forEach var="tknhacungcap" items="${tknhacungcaps}">
                    <tr>
                        <td>${tknhacungcap.nhaCungCap.mancc}</td>
                        <td>${tknhacungcap.nhaCungCap.ten}</td>
                        <td>${tknhacungcap.nhaCungCap.diachi}</td>
                        <td>${tknhacungcap.nhaCungCap.sdt}</td>
                        <td>${tknhacungcap.soluongnhap}</td>
                        <td>
                            <a href="luotNhapTheoNcc?value=${tknhacungcap.nhaCungCap.mancc}" class="btn btn-info"><i class="fas fa-info"></i></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
